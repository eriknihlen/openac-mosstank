...
internal sealed partial class LootController
{
    ...
    /// <summary>
    /// True while a description this controller asked for is still
    /// outstanding. The appraisal slot holds one answer at a time, so a
    /// second reader of it can stand down on this instead of taking the
    /// answer this controller is waiting for.
    /// </summary>
    internal bool IsIdentifying =>
        _awaitingAppraisal != 0u || _awaitingCorpseAppraisal != 0u;
