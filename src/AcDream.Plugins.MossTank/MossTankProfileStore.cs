...
internal sealed class MossTankProfileStore
{
    ...
    private sealed class SideCarDocument
    {
        ...
        public double InventoryGiveRangeMeters { get; set; } = 15d;
        ...
        /// <summary>
        /// How many times a jump asked for by command charges before it gives
        /// up.
        /// </summary>
        public int NavigationJumpAttempts { get; set; } = 3;
            ...
            ISet<string> logChannels) => new()
        {
            ...
            InventoryGiveBusyRetryLimit = settings.Inventory.GiveBusyRetryLimit,
            ...
            NavigationJumpAttempts = settings.Navigation.JumpAttempts,
        };
            ...
            IPluginLogger? logger = null)
        {
            ...
            settings.Inventory.GiveRangeMeters = Math.Clamp(
                InventoryGiveRangeMeters, 0d, 1000d);
            settings.Inventory.GiveDelaySeconds = Math.Clamp(
                InventoryGiveDelaySeconds, 0d, 60d);
            settings.Inventory.GiveBusyRetryLimit = Math.Clamp(
                InventoryGiveBusyRetryLimit, 1, 100);
            settings.Inventory.GiveFailureLimit = Math.Clamp(
                InventoryGiveFailureLimit, 0, 100);
            ...
            settings.Navigation.JumpAttempts =
                Math.Clamp(NavigationJumpAttempts, 1, 20);
        }
