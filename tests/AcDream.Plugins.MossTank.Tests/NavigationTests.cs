...
public sealed class NavigationTests
{
    ...
    public void RouteStoreMigratesFlatNavMarkedFileIntoNavsFolderWithMarkerStripped()
    {
        ...
        Assert.True(storage.Text.ContainsKey("mosstank/navs/Hunt.af"));
    ...
    public void RouteStoreMigratesFlatHiddenAutoRouteFileWithMarkerStripped()
    {
        ...
        Assert.True(storage.Text.ContainsKey("mosstank/navs/--Barris_Coldeve.af"));
    ...
    public void RouteStoreLeavesFlatFileInPlaceWhenNavsDestinationAlreadyExists()
    {
        ...
        storage.Text["mosstank/navs/Hunt.af"] = canonicalContent;
        ...
        Assert.Equal(canonicalContent, storage.Text["mosstank/navs/Hunt.af"]);
        ...
        Assert.Contains(
            ...
            message => message.Contains("nav_Hunt.af", StringComparison.Ordinal)
                && message.Contains("mosstank/navs/Hunt.af", StringComparison.Ordinal));
    }
